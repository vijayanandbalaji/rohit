...
<body>
	...
	<div class="container-fluid">
		<div class="jumbotron" id="sellJumbotron">
			<center>
				<h1>
					<b>Post Your Ad</b>
				</h1>
	...
	<div class="container">
		...
		<form action="/olx/app/SellItem" method="post">
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6">
					<div class="form-group">
						<label for="pname"><b>PRODUCT NAME</b></label><br> <input
							type="text" name="item_name" id="sellproduct_textbox" required>
					</div>
					<div class="form-group">
						<label for="category"><b>CATEGORY</b></label><br> <select
							name="itemCategory.category_id" id="select_category"  required>
					...
					<div class="form-group">
						<label for="addimages"><b>YEARS OF USAGE</b></label><br> <input
							type="number" name="years_of_usage" id="sellproduct_textbox"  required>
					</div>
					<div class="form-group">
						<label for="addimages"><b>PRICE</b></label><br> <input
							type="text" name="price" id="sellproduct_textbox"  required>
					</div>
					<br>
					<div class="form-group">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 ">
					<div class="imagediv">
						<input type='file' name="item_image" onchange="readURL(this);"  required />
